...
const PasswordStrengthBarWrapper = ({ currentPassword, scoreChangeCallback }: PasswordStrengthBarWrapperArgs): JSX.Element | null => {
        ...
        return (
            <Suspense fallback={""}>
                <PasswordStrengthBar
                    ...
                    onChangeScore={(score, feedback) => scoreChangeCallback(score, feedback)}
