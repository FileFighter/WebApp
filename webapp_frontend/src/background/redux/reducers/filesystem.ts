import {FilesystemActionTypes, FilesystemState} from "../actions/filesystemTypes";
...
export default function filesystem(state = initialState, action: FilesystemActionTypes) {
    ...
    switch (action.type) {
        case "ADD_TO_SELECTED": {
            ...
            return {
                selectedFsEnties: state.selectedFsEnties.concat(action.payload) //concat because it does not modify the original array
            }
        }
